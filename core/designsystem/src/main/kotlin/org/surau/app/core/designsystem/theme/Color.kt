 ...
 */
// Light
internal val HeroLightBackground = Color(0xFFF4F4F0) // oklch(96.60% 0.0050 106.50)
internal val HeroLightSurface = Color(0xFFFDFDFC) // color-mix(white 80%, transparent) over background
internal val HeroLightSurfaceGlass = Color(0xCCFFFFFF) // translucent white @ 80% for glassy surfaces
internal val HeroLightSurfaceSecondary = Color(0xFFE8E8E3) // oklch(93.00% 0.0070 106.50)
internal val HeroLightSurfaceTertiary = Color(0xFFEFEFEA) // oklch(95.00% 0.0060 106.50)
internal val HeroLightDefault = Color(0xFFE8E8E3) // oklch(93.00% 0.0070 106.50)
internal val HeroLightAccent = Color(0xFF4F772D) // oklch(52.25% 0.1130 132.94)
internal val HeroLightMuted = Color(0xFF5B5B4B) // oklch(46.60% 0.0250 107.30)
internal val HeroLightScrollbar = Color(0xFFD8D8D0) // oklch(88.00% 0.0110 106.60)
internal val HeroLightBorder = Color(0xFFDEDED8) // oklch(90.00% 0.0090 106.60) — also field-border
internal val HeroLightSeparator = Color(0xFFE5E5E0) // oklch(92.00% 0.0070 106.50)
...
// Dark
internal val HeroDarkBackground = Color(0xFF151510) // oklch(19.50% 0.0110 107.30)
internal val HeroDarkSurface = Color(0xFF1D1D16) // oklch(22.80% 0.0130 107.40)
internal val HeroDarkSurfaceSecondary = Color(0xFF212119) // oklch(24.50% 0.0140 107.40)
internal val HeroDarkSurfaceTertiary = Color(0xFF26261D) // oklch(26.50% 0.0150 107.40)
internal val HeroDarkOverlay = Color(0xFF191912) // oklch(21.00% 0.0120 107.30)
internal val HeroDarkDefault = Color(0xFF2B2B22) // oklch(28.60% 0.0160 107.40)
internal val HeroDarkAccent = Color(0xFF6A994E) // oklch(63.12% 0.1166 134.93)
internal val HeroDarkMuted = Color(0xFFABAB9C) // oklch(73.70% 0.0210 106.90)
internal val HeroDarkScrollbar = Color(0xFFABAB9C) // oklch(73.70% 0.0210 106.90)
internal val HeroDarkFieldBackground = Color(0xFF191912) // oklch(21.00% 0.0120 107.30)
internal val HeroDarkFieldBorder = Color(0xFF313127) // oklch(31.00% 0.0180 107.40)
internal val HeroDarkBorder = Color(0xFF313127) // oklch(31.00% 0.0180 107.40)
internal val HeroDarkSeparator = Color(0xFF25251D) // oklch(26.00% 0.0140 107.40)
internal val HeroDarkSegment = Color(0xFF49493C) // oklch(40.00% 0.0200 107.30)
