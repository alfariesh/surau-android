    ...
    Box(modifier = modifier) {
        val containerColor = if (followed) {
            ...
            MaterialTheme.colorScheme.surfaceVariant.copy(
                alpha = SurauTagDefaults.UNFOLLOWED_TOPIC_TAG_CONTAINER_ALPHA,
            )
        }
        TextButton(
            onClick = onClick,
            ...
            colors = ButtonDefaults.textButtonColors(
                ...
                disabledContainerColor = MaterialTheme.colorScheme.onSurface.copy(
                    alpha = SurauTagDefaults.DISABLED_TOPIC_TAG_CONTAINER_ALPHA,
                ),
            ),
        ) {
...
fun TagPreview() {
    SurauTheme {
        SurauTopicTag(followed = true, onClick = {}) {
