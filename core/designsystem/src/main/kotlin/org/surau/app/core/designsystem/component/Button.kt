        ...
        border = BorderStroke(
            ...
            color = if (enabled) {
                ...
                MaterialTheme.colorScheme.onSurface.copy(
                    alpha = SurauButtonDefaults.DISABLED_OUTLINED_BUTTON_BORDER_ALPHA,
                )
            },
        ),
        contentPadding = contentPadding,
 ...
 */
@Composable
private fun SurauButtonContent(
    text: @Composable () -> Unit,
    leadingIcon: @Composable (() -> Unit)? = null,
) {
    if (leadingIcon != null) {
...
@ThemePreviews
@Composable
fun SurauButtonPreview() {
    SurauTheme {
        SurauBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            SurauButton(onClick = {}, text = { Text("Test button") })
        }
    }
}
...
@ThemePreviews
@Composable
fun SurauOutlinedButtonPreview() {
    SurauTheme {
        SurauBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            SurauOutlinedButton(onClick = {}, text = { Text("Test button") })
        }
    }
}
...
@ThemePreviews
@Composable
fun SurauButtonLeadingIconPreview() {
    SurauTheme {
        SurauBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            SurauButton(
                onClick = {},
                text = { Text("Test button") },
                leadingIcon = { Icon(imageVector = SurauIcons.Add, contentDescription = null) },
            )
        }
    }
}
