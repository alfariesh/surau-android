...
fun SurauViewToggleButton(
    ...
    TextButton(
        ...
        contentPadding = SurauViewToggleDefaults.ViewToggleButtonContentPadding,
    ) {
        SurauViewToggleButtonContent(
            text = if (expanded) expandedText else compactText,
            trailingIcon = {
                Icon(
                    imageVector = if (expanded) SurauIcons.ViewDay else SurauIcons.ShortText,
 ...
 */
@Composable
private fun SurauViewToggleButtonContent(
 ...
 */
object SurauViewToggleDefaults {
    // TODO: File bug
