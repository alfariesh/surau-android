...
class NavigationScreenshotTests {
        ...
        composeTestRule.setContent {
            CompositionLocalProvider(
                ...
                DeviceConfigurationOverride(
                    ...
                    SurauTheme {
                        SurauNavigationBarExample("Looong item")
                    }
                }
            }
        }
    ...
    @Composable
    private fun SurauNavigationBarExample(label: String = "Item") {
        SurauNavigationBar {
            (0..2).forEach { index ->
                SurauNavigationBarItem(
                    icon = {
                        Icon(
                            imageVector = SurauIcons.UpcomingBorder,
                            contentDescription = "",
                        )
                    },
                    selectedIcon = {
                        Icon(
                            imageVector = SurauIcons.Upcoming,
                            contentDescription = "",
                        )
                    },
                    label = { Text(label) },
