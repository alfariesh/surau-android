...
import org.surau.app.core.designsystem.component.SurauWidgetLegendItem
...
class WidgetScreenshotTests {

    @get:Rule
    val composeTestRule = createAndroidComposeRule<ComponentActivity>()

    @Test
    fun widget_multipleThemes() {
        composeTestRule.captureMultiTheme("Widget") {
            Surface {
                SurauWidget(
