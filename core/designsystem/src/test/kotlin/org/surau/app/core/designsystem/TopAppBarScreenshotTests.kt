...
import org.surau.app.core.designsystem.component.SurauTopAppBar
...
class TopAppBarScreenshotTests {
    ...
    @Composable
    private fun SurauTopAppBarExample() {
        SurauTopAppBar(
            titleRes = android.R.string.untitled,
            navigationIcon = SurauIcons.Search,
            navigationIconContentDescription = "Navigation icon",
            actionIcon = SurauIcons.MoreVert,
