...
class SegmentedControlScreenshotTests {
    ...
    @Test
    fun segmentedControl_sizes_multipleThemes() {
        val options = listOf("Hari", "Minggu", "Bulan")
        composeTestRule.captureMultiTheme("SegmentedControl") {
            Surface {
                Column(
                    modifier = Modifier.padding(16.dp),
                    verticalArrangement = Arrangement.spacedBy(12.dp),
                ) {
                    SurauSegmentSize.entries.forEach { size ->
