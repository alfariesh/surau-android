...
class SurfaceScreenshotTests {

    @get:Rule
    val composeTestRule = createAndroidComposeRule<ComponentActivity>()

    @Test
    fun surface_variants_multipleThemes() {
        composeTestRule.captureMultiTheme("Surface") {
            Surface {
                Column(
                    ...
                    SurauSurfaceVariant.entries.forEach { variant ->
                        SurauSurface(variant = variant, modifier = Modifier.fillMaxWidth()) {
